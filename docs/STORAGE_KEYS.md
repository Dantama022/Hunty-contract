...
| `POOL_RFD_KEY` | `PRFD` | `(PRFD, hunt_id)` refunded |
...
| `PAUSE_FUNDING_KEY` | `PAUSE_FD` | granular pause for funding operations (#628) |
| `PAUSE_DIST_KEY` | `PAUSE_DS` | granular pause for distribution operations (#628) |
